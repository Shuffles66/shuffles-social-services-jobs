...
- **ATS-friendly résumé builder** — structured to health/disability/aged-care best practice (Name & contact, Professional summary, Compliance & credentials, Core skills, Employment history, Education, Referees), built from the member's profile. A layout toggle offers a plain, single-column, photo-free **ATS-friendly** format (what employers' recruitment systems can read) or a **Styled** one, with built-in plain-English ATS do's/don'ts and a credible "What is an ATS?" guide link right in the tool.

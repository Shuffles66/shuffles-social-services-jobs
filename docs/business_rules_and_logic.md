...
- **Last updated:** v1.3.0 (2026-06-08) — security hardening pass (page-level + sitemap visibility enforcement, autofill SSRF guard, org-team approve consent, view-as admin guard).

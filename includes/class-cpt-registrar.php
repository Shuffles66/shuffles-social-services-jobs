	...
	private function meta_defs() {
		return array(
			...
			'sssj_worker' => array(
				...
				// NDIS registration for sole-trader individuals (registered in their own right).
				'ndis_registered'         => array( 'boolean', true, 'bool' ),
				'ndis_register_id'        => array( 'string', true, 'text' ),
				'ndis_status'             => array( 'string', true, 'text' ),
				'ndis_groups'             => array( 'string', true, 'text' ),
				'ndis_groups_list'        => array( 'string', false, 'text' ),
				'ndis_in_force_until'     => array( 'string', true, 'text' ),
			...
			'sssj_org' => array(
				...
				'org_size'        => array( 'string', true, 'key' ),
				'org_structure'   => array( 'string', true, 'key' ),

	...
	public static function suites() {
		$s = array(
			...
			array(
				...
				'cases' => array(
					array( 'id' => 'disp-hero', 'do' => __( 'Put [sssj_hero title="…" button_text="Browse jobs" button_url="/jobs"] on a page.', 'shuffles-social-services-jobs' ), 'expect' => __( 'A gradient hero banner fades in with the headline, call-to-action button(s), and a “🛡️ Safety, built in” strip listing the privacy/verification guardrails. safety="off" hides the strip.', 'shuffles-social-services-jobs' ) ),

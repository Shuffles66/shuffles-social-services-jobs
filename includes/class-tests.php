		...
		$s = array(
			...
			array(
				...
				'cases' => array(
					...
					array( 'id' => 'disp-whyus', 'do' => __( 'Create a page via Settings → Pages → “Why us (benefits)” (or put [sssj_why_us] on a page) and open it.', 'shuffles-social-services-jobs' ), 'expect' => __( 'A point-form benefits list renders, each point with an icon, heading and short blurb (interconnectivity, community/Facebook groups, purpose-built, employment + contracting, résumé creation, privacy/hide profile, high visibility, giving back / fair pricing).', 'shuffles-social-services-jobs' ) ),
